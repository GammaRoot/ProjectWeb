...
<head>
    ...
    <link href="create-posts.css" rel="stylesheet">
</head>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input  style="width:100%;" type="text" name="brand" required ></td>
                                            <td><input  style="width:100%;" type="text" name="description" required></td>
                                            <td><input  style="width:100%;" type="file" name="image[]" required></td>                                      
                                            <td><input type="submit" name="save" class="btn btn-info" value="Create"></td>
                                            </form>
                                        </tr>
                                    </tbody>
                                </table>
